...
class TestElements:
    ...
    class TestWebTable:
        ...
        def test_web_table_update_person_info(self, driver):     #обновляем возраст
            web_table_page = WebTablePage(driver, 'https://demoqa.com/webtables')
            web_table_page.open()
        ...
        def test_web_table_delete_person_info(self, driver): #удаляем строку
            web_table_page = WebTablePage(driver, 'https://demoqa.com/webtables')
            web_table_page.open()
    ...
    class TestLinkPage:
        ...
        def test_broken_link(self, driver):
            links_page = LinksPage(driver, 'https://demoqa.com/links')
            links_page.open()
            response_cod = links_page.check_broken_link('https://demoqa.com/bad-request')
            assert response_cod == 400, "the link works or the status code in son 400"