...
class BasePage:
    ...
    def element_are_visible(self, locator, timout=5):
    ...
    def element_are_present(self, locator, timout=5):
    ...
    def go_to_element(self, element):
        self.driver.execute_script("argument[0].scrollIntoView();", element) # перемещает, скролит сразу к нужному элементу